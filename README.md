...
Меня зовут **Рустэм**, я QA-инженер с опытом тестирования веб‑приложений, мобильных приложений и телеграм-ботов и мини аппок. Сейчас развиваюсь в сторону **Automation QA** и активно изучаю **Cypress/Playwright** и автоматизацию тестирования..
